...
const CurlError_1 = require("./CurlError");
const CurlEasyError_1 = require("./CurlEasyError");
...
const create = (defaultOptions = {}) => {
    ...
    const setObjectPoolLimit = (limit) => {
        poolLimit = limit;
        if (limit <= 0) {
    ...
    function curly(url, options = {}) {
        ...
        // streams!
        const { curlyStreamResponse, curlyStreamResponseHighWaterMark, curlyStreamUpload, curlyMimePost, } = finalOptions;
        ...
        return new Promise((resolve, reject) => {
            ...
            curlHandle.on('error', (error, errorCode) => {
                returnToPool(curlHandle);
                const errorToUse = error instanceof CurlError_1.CurlError
                    ? error
                    : new CurlEasyError_1.CurlEasyError(error.message, errorCode, { cause: error });
