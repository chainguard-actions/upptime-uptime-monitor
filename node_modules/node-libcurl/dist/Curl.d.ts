...
declare class Curl extends EventEmitter {
    ...
    protected nextPauseFlags: CurlPause | null;
    /**
...
interface Curl {
     ...
     */
    setOpt(option: DataCallbackOptions, value: ((this: Easy, data: Buffer, size: number, nmemb: number) => number) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: ProgressCallbackOptions, value: ((this: Easy, dltotal: number, dlnow: number, ultotal: number, ulnow: number) => number | CurlProgressFunc) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     ...
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'CHUNK_BGN_FUNCTION', value: ((this: Easy, fileInfo: FileInfo, remains: number) => CurlChunk) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'CHUNK_END_FUNCTION', value: ((this: Easy) => CurlChunk) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'DEBUGFUNCTION', value: ((this: Easy, type: CurlInfoDebug, data: Buffer) => 0) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'FNMATCH_FUNCTION', value: ((this: Easy, pattern: string, value: string) => CurlFnMatchFunc) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
    ...
    }) => null | CurlHstsCacheEntry | CurlHstsCacheEntry[]) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'HSTSWRITEFUNCTION', value: ((this: Easy, cacheEntry: CurlHstsCacheEntry, cacheCount: CurlHstsCacheCount) => any) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'INTERLEAVEFUNCTION', value: ((this: Easy, data: Buffer, size: number, nmemb: number) => number) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'PREREQFUNCTION', value: ((this: Easy, connPrimaryIp: string, connLocalIp: string, connPrimaryPort: number, conLocalPort: number) => CurlPreReqFunc) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'SEEKFUNCTION', value: ((this: Easy, offset: number, origin: number) => number) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'SSH_HOSTKEYFUNCTION', value: ((this: Easy, keytype: CurlSshKeyType, key: Buffer) => CurlSshKeyMatch) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
     * Official libcurl documentation: [`curl_easy_setopt()`](http://curl.haxx.se/libcurl/c/curl_easy_setopt.html)
     */
    setOpt(option: 'TRAILERFUNCTION', value: ((this: Easy) => string[] | false) | null): this;
    /**
     * Use {@link Curl.option|`Curl.option`} for predefined constants.
     *
     *
